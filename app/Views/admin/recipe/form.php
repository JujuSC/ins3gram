        ...
        <div class="card h-100">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="tabsRecipe">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#step-tab-pane">Etapes</button>
                    </li>
                    <?php if(isset($recipe)): ?>
                    <li class="nav-item">
                ...
                <div class="tab-content p-3 border border-1 border-top-0 rounded rounded-top-0" id="tabsRecipeContent">
                    ...
                    <div class="tab-pane fade show active" id="general-tab-pane" role="tabpanel">
                        <div class="mb-3">
                            <label>Description globale de la recette</label>
                            <textarea class="form-control" row="3" id="description" name="description"></textarea>
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="switchActive" name="alcool">
